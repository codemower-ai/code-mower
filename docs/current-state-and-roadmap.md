...
hosted CodeMower.com surface, and the near-term path from the current v1.0.13
...
The v1.0.13 supervised-pilot release keeps the Python 3.12+ runtime contract,
...
- the current public PyPI package-install rehearsal from `v1.0.13` /
  `code-mower==1.0.13` with a
...
The v1.0.13 line now gives adopters that trust test plus first productivity
