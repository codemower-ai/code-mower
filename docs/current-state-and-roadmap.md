...
The current verified public beta baseline is `v0.5.0-beta.47`, published on
PyPI as `code-mower==0.5.0b47`. It is intended to be installed from the package
...
- a beta.39 private-repo install rehearsal target against
  ...
  to prove `code-mower==0.5.0b47` can detect and dry-run repository-native
...
- a public PyPI package-install rehearsal from `code-mower==0.5.0b47` with a
