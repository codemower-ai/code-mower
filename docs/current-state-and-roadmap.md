...
The current verified public beta baseline is `v0.5.0-beta.42`, published on
PyPI as `code-mower==0.5.0b42`. It is intended to be installed from the package
...
- a beta.39 private-repo install rehearsal target against
  ...
  to prove `code-mower==0.5.0b42` can detect and dry-run repository-native
...
- a public PyPI package-install rehearsal from `code-mower==0.5.0b42` with a
