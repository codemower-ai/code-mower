...
hosted CodeMower.com surface, and the near-term path from the current v1.1.2
...
- the current public PyPI package-install rehearsal from `v1.1.2` /
  `code-mower==1.1.2` with a
...
The v1.1.2 line now gives adopters that trust test plus first productivity
