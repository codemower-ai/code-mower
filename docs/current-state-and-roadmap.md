...
hosted CodeMower.com surface, and the near-term path from the current v1.1.1
...
The v1.1.1 supervised-pilot release keeps the Python 3.12+ runtime contract,
...
- the current public PyPI package-install rehearsal from `v1.1.1` /
  `code-mower==1.1.1` with a
...
The v1.1.1 line now gives adopters that trust test plus first productivity
