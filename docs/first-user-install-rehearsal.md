...
code-mower migration package-install-rehearsal \
  --package-spec code-mower==0.5.0b39 \
...
```bash
code-mower migration package-install-rehearsal \
  --package-spec "git+https://github.com/codemower-ai/code-mower.git@v0.5.0-beta.39" \
  --python "$(command -v python3.12)" \
  --json
```
...
The latest public-package rehearsal for `v0.5.0-beta.39` was run from PyPI with:
...
- package source: [PyPI `code-mower==0.5.0b39`](https://pypi.org/project/code-mower/0.5.0b39/)
...
TestPyPI artifact:
[https://test.pypi.org/project/code-mower/0.5.0b39/](https://test.pypi.org/project/code-mower/0.5.0b39/).
