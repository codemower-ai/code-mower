...
| --- | --- |
| Laptop/workstation | `pipx install --python "$CODE_MOWER_PYTHON" code-mower==1.0.3` |
| Hosted agent, CI box, or minimal Linux VM | `uv tool install --python 3.12 code-mower==1.0.3` |
...
`1.0.3` is the supervised-pilot release. To follow a future prerelease line
