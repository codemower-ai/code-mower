...
Start here:
https://github.com/codemower-ai/code-mower/blob/v0.5.0-alpha.37/docs/try-in-10-minutes.md
...
1. Verify the tagged install command in a fresh repo:
   ...
   ```bash
   pipx install --python python3.12 "git+https://github.com/codemower-ai/code-mower.git@v0.5.0-alpha.37"
   code-mower --version
   ```
