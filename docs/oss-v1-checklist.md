...
The current public-release baseline is `v1.1.1` of the standalone
...
- package-install rehearsals against the exact TestPyPI and PyPI artifacts as
  `code-mower==1.1.1` after those workflow runs finish, with workflow run
