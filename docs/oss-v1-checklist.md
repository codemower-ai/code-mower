...
The current public-release baseline is `v0.5.0-beta.44` of the standalone
...
- public package installation from PyPI and TestPyPI as `code-mower==0.5.0b44`;
...
```bash
pipx install --python python3.12 code-mower==0.5.0b44
