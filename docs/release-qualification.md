...
- **Adoption doctor:** Run `code-mower doctor --adoption` to validate release campaign readiness across configured providers, adapters, credentials, writable storage, and Board visibility before dispatching.
