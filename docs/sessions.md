...
qualification documented below are included in `code-mower==1.5.0`.
...
and startup lease commands described here are included in the same release;
the historical `v1.4.0` artifacts remain unchanged.
