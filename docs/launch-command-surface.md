...
| `code-mower board serve --repo OWNER/REPO` | Serve redacted lane status plus local verdict/spend timelines in a local read-only browser board. | no | GitHub optional |
