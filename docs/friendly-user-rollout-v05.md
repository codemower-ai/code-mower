...
The current package-index release baseline is `v1.3.1`, with pinned package install spec `code-mower==1.3.1`. Release evidence is recorded on the GitHub release and in the first-user install rehearsal.
