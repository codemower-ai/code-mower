...
this document is the current v1.0.7 supervised-pilot release.
...
The current package-index release baseline is `v1.0.7`, with pinned package install spec `code-mower==1.0.7`. Release evidence is recorded on the GitHub release and in the first-user install rehearsal.
