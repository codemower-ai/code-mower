...
The current package-index beta baseline is `v0.9.3-beta.1`, with pinned package install spec `code-mower==0.9.3b1`. Release evidence is recorded on the GitHub release and in the first-user install rehearsal.
