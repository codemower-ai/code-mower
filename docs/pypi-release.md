...
/tmp/code-mower-pypi-smoke/bin/python -m pip install --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ code-mower==0.5.0a25
...
code-mower migration package-install-rehearsal \
  --package-spec code-mower==0.5.0a25 \
