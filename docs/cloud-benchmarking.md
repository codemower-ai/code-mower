...
### Current v1.0.12: Metadata-Only Upload, Board, Productivity, And Qualification

The current v1.0.12 line keeps cloud sharing opt-in for adopters who explicitly
...
code-mower release qualify --release-tag v1.0.12 --package-spec code-mower==1.0.12 --output adoption-result.json --execute
