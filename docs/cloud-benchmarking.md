...
### Current v1.0.9: Metadata-Only Upload, Board, Productivity, And Qualification

The current v1.0.9 line keeps cloud sharing opt-in for adopters who explicitly
...
code-mower release qualify --release-tag v1.0.9 --package-spec code-mower==1.0.9 --output adoption-result.json --execute
