...
### Current v1.1.1: Metadata-Only Upload, Board, Productivity, And Qualification

The current v1.1.1 line keeps cloud sharing opt-in for adopters who explicitly
...
code-mower release qualify --release-tag v1.1.1 --package-spec code-mower==1.1.1 --output adoption-result.json --execute
