...
# refreshed to the regenerated bytes; every other accepted digest stays frozen at
# the accepted base, and the complete-baseline checksum in
# tests/test_lineage_producer_artifacts.py is refreshed with them.
