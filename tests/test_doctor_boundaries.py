...
class DoctorBoundaryTests(unittest.TestCase):
    ...
    def test_doctor_check_modules_are_explicit_package_seams(self) -> None:
        expected_modules = (
            ...
            "code_mower.doctor_checks.campaign_auth",
            ...
            "code_mower.doctor_checks.github_actions_failure_selection",
            ...
            "code_mower.doctor_checks.provider_env_required",
            "code_mower.doctor_checks.provider_env_tokens",
