    ...
    def test_package_content_legacy_tools_import_falls_back_without_tools_shim(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            try:
                ...
                self.assertEqual(
                    legacy_module.current_alpha_package_spec("0.5.0b2"),
                    "git+https://github.com/codemower-ai/code-mower.git@v0.5.0-beta.2",
                )
            finally:
            ...
            completed = subprocess.run(
                [
                    ...
                    (
                        ...
                        "print(c.current_alpha_package_spec('0.5.0b2'))"
                    ),
                ],
                cwd=tmp_path,
...
""",
    ...
    def test_release_readiness_reports_package_index_promotion_gate(self) -> None:
        ...
        self.assertEqual(payload["status"], "pass")
        self.assertEqual(payload["version"], "0.5.0b2")
        self.assertEqual(payload["release_tag"], "v0.5.0-beta.2")
        self.assertEqual(payload["alpha_tag"], "v0.5.0-beta.2")
        self.assertEqual(payload["package_index_spec"], "code-mower==0.5.0b2")
    ...
    def test_release_readiness_fails_on_materialized_package_version_drift(
        ...
        self.assertEqual(check["detail"]["source_version"], "0.5.0b2")
