...
class ReleaseHygieneTests(unittest.TestCase):
    def test_version_is_current_v05_alpha(self) -> None:
        self.assertEqual(__version__, "0.5.0a67")
    ...
    def test_cli_default_help_is_first_user_focused(self) -> None:
        ...
        self.assertIn(
            (
                ...
                "git+https://github.com/codemower-ai/code-mower.git@v0.5.0-alpha.67 "
                "--json"
            ),
            help_text,
        )
    ...
    def test_package_content_legacy_tools_import_falls_back_without_tools_shim(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            try:
                ...
                self.assertEqual(
                    legacy_module.current_alpha_package_spec("0.5.0a67"),
                    "git+https://github.com/codemower-ai/code-mower.git@v0.5.0-alpha.67",
                )
            finally:
            ...
            completed = subprocess.run(
                [
                    ...
                    (
                        ...
                        "print(c.current_alpha_package_spec('0.5.0a67'))"
                    ),
                ],
                cwd=tmp_path,
...
""",
    ...
    def test_release_readiness_reports_package_index_promotion_gate(self) -> None:
        ...
        self.assertEqual(payload["status"], "pass")
        self.assertEqual(payload["version"], "0.5.0a67")
        self.assertEqual(payload["alpha_tag"], "v0.5.0-alpha.67")
        self.assertEqual(payload["package_index_spec"], "code-mower==0.5.0a67")
    ...
    def test_release_readiness_fails_on_materialized_package_version_drift(
        ...
        self.assertEqual(check["detail"]["source_version"], "0.5.0a67")
    ...
    def test_release_readiness_tag_derivation_supports_release_stages(self) -> None:
        self.assertEqual(
            release_readiness._release_tag_for_version("0.5.0a67"),
            "v0.5.0-alpha.67",
        )
        self.assertEqual(
            code_mower_versioning.release_tag_for_version("0.5.0a67"),
            "v0.5.0-alpha.67",
        )
        self.assertEqual(
