...
class ReleaseHygieneTests(unittest.TestCase):
    def test_version_is_v05_alpha_25(self) -> None:
        self.assertEqual(__version__, "0.5.0a27")
    ...
    def test_cli_default_help_is_first_user_focused(self) -> None:
        ...
        self.assertIn(
            (
                ...
                "git+https://github.com/codemower-ai/code-mower.git@v0.5.0-alpha.27 "
                "--json"
            ),
            help_text,
        )
...
""",
    ...
    def test_release_readiness_reports_package_index_promotion_gate(self) -> None:
        ...
        self.assertEqual(payload["status"], "pass")
        self.assertEqual(payload["version"], "0.5.0a27")
        self.assertEqual(payload["alpha_tag"], "v0.5.0-alpha.27")
        self.assertEqual(payload["package_index_spec"], "code-mower==0.5.0a27")
    ...
    def test_release_readiness_fails_on_materialized_package_version_drift(
        ...
        self.assertEqual(check["detail"]["source_version"], "0.5.0a27")
    ...
    def test_release_readiness_tag_derivation_supports_release_stages(self) -> None:
        self.assertEqual(
            release_readiness._release_tag_for_version("0.5.0a27"),
            "v0.5.0-alpha.27",
        )
        self.assertEqual(
