...
class ReleaseHygieneTests(unittest.TestCase):
    def test_version_is_current_beta_prerelease(self) -> None:
        self.assertEqual(__version__, "0.6.0b1")
...
""",
    ...
    def test_direct_cli_execution_points_to_package_or_dev_wrapper(self) -> None:
        ...
        self.assertNotEqual(completed.returncode, 0)
        self.assertIn("pipx install code-mower==0.6.0b1", completed.stderr)
    ...
    def test_package_content_legacy_tools_import_falls_back_without_tools_shim(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            try:
                ...
                self.assertEqual(
                    legacy_module.current_alpha_package_spec("0.6.0b1"),
                    "code-mower==0.6.0b1",
                )
            finally:
            ...
            completed = subprocess.run(
                [
                    ...
                    (
                        ...
                        "print(c.current_alpha_package_spec('0.6.0b1'))"
                    ),
                ],
                cwd=tmp_path,
...
""",
    ...
    def test_package_install_rehearsal_resolves_local_package_specs(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(
                code_mower_migration._resolve_install_package_spec(
                    "git+https://github.com/codemower-ai/code-mower.git@v0.6.0-beta.1",
                    base_dir=package,
                ),
                "git+https://github.com/codemower-ai/code-mower.git@v0.6.0-beta.1",
            )
    ...
    def test_release_readiness_reports_package_index_promotion_gate(self) -> None:
        ...
        self.assertEqual(payload["status"], "pass")
        self.assertEqual(payload["version"], "0.6.0b1")
        self.assertEqual(payload["release_tag"], "v0.6.0-beta.1")
        self.assertEqual(payload["alpha_tag"], "v0.6.0-beta.1")
        self.assertEqual(payload["package_index_spec"], "code-mower==0.6.0b1")
        ...
        self.assertIn("--ref v0.6.0-beta.1", commands["dry-run-release-workflow"])
        self.assertNotIn("--ref main", commands["dry-run-release-workflow"])
        self.assertIn("--ref v0.6.0-beta.1", commands["publish-testpypi-candidate"])
    ...
    def test_release_readiness_fails_on_materialized_package_version_drift(
        ...
        self.assertEqual(check["detail"]["source_version"], "0.6.0b1")
    ...
    def test_release_readiness_tag_derivation_supports_release_stages(self) -> None:
        self.assertEqual(
            release_readiness._release_tag_for_version("0.6.0b1"),
            "v0.6.0-beta.1",
        )
        self.assertEqual(
            code_mower_versioning.release_tag_for_version("0.6.0b1"),
            "v0.6.0-beta.1",
        )
        self.assertEqual(
            release_readiness._release_tag_for_version("0.6.0b1"),
    ...
    def test_public_release_baseline_helpers_derive_announcement_links(self) -> None:
        self.assertEqual(
            ...
            (
                "The current public beta baseline is `v0.6.0-beta.1`, with "
                "pinned package-index install spec `code-mower==0.6.0b1`. "
        ...
        self.assertEqual(
            ...
            (
                ...
                "v0.6.0-beta.1/docs/try-in-10-minutes.md"
            ),
        )
    ...
    def test_current_beta_release_docs_record_package_index_procedure(self) -> None:
        ...
        current_status = (
            "The current public beta baseline is `v0.6.0-beta.1`, with pinned "
            "package-index install spec `code-mower==0.6.0b1`. Release "
        ...
        self.assertIn(
            "The v0.6 beta entrypoint is `code-mower==0.6.0b1`",
            public_release,
        )
        self.assertIn(
        ...
        self.assertIn(
            "The current public-release baseline is `v0.6.0-beta.1`",
            oss_checklist,
        )
        self.assertIn(
        ...
        self.assertEqual(first_user.count("  --ref v0.6.0-beta.1 \\"), 2)
        ...
        self.assertNotIn(
            "The latest public-package rehearsal for `v0.6.0-beta.1` was run",
            first_user,
        )
        self.assertNotIn("TestPyPI is not\npublished for `0.6.0b1`", first_user)
        for text in (readme, current_state, rollout):
            self.assertNotIn(
                "published on PyPI as `code-mower==0.6.0b1`",
                text,
            )
            self.assertNotIn(
    ...
    def test_v06_truth_baseline_records_provider_contract_scope(self) -> None:
        ...
        self.assertIn("`v0.6.0-beta.1`", baseline)
        self.assertIn("`code-mower==0.6.0b1`", baseline)
    ...
    def test_v06_adoption_polish_docs_cover_cold_start_surface(self) -> None:
        ...
        self.assertIn("Code Mower v0.6.0-beta.1 Release Notes", release_notes)
    ...
    def test_package_command_inventory_derives_current_prerelease_spec(self) -> None:
        ...
        self.assertEqual(
            code_mower_package_content.current_alpha_package_spec("0.6.0b1"),
            "code-mower==0.6.0b1",
        )
    ...
    def test_next_steps_includes_cloud_upload_dry_run_after_export(self) -> None:
        ...
        self.assertIn("code-mower==0.6.0b1", package_step["command"])
