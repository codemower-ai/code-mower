...
if __package__ in {None, ""}:
    ...
    if module_dir.name == "code_mower":  # pragma: no cover - direct package path.
        from code_mower import config as code_mower_config
        from code_mower import package as code_mower_package
        from code_mower.doctor_checks.common import (
        ...
        from code_mower.doctor_checks.github import _check_github_setup
        from code_mower.doctor_checks.privacy import (
            _auth_probe_output_detail,
            _check_cloud_token_surface,
        )
        from code_mower.doctor_checks.providers import (
            _check_lane_runtime,
            _effective_lane,
            _provider_template_coverage,
            _selected_lanes,
        )
        from code_mower.doctor_checks.runtime import _global_runtime_checks
    else:  # pragma: no cover - extracted direct CLI path.
        from tools import code_mower_config, code_mower_package
        from tools.doctor_checks.common import (
            ACTIONS_COST_SAMPLE_DEFAULT,
            ACTIONS_COST_SAMPLE_MAX,
            DoctorCheck,
            DoctorReport,
        ...
        from tools.doctor_checks.github import _check_github_setup
        from tools.doctor_checks.privacy import (
            _auth_probe_output_detail,
            _check_cloud_token_surface,
        )
        from tools.doctor_checks.providers import (
            _check_lane_runtime,
            _effective_lane,
            _provider_template_coverage,
            _selected_lanes,
        )
        from tools.doctor_checks.runtime import _global_runtime_checks
    ...
    from .doctor_checks.common import (
        ACTIONS_COST_SAMPLE_DEFAULT,
        ACTIONS_COST_SAMPLE_MAX,
        DoctorCheck,
        DoctorReport,
    ...
    from .doctor_checks.github import _check_github_setup
    from .doctor_checks.privacy import (
        _auth_probe_output_detail,
        _check_cloud_token_surface,
    )
    from .doctor_checks.providers import (
        _check_lane_runtime,
        _effective_lane,
        _provider_template_coverage,
        _selected_lanes,
    )
    from .doctor_checks.runtime import _global_runtime_checks
...
def run_doctor(
    *,
    ...
    effective_lanes: list[tuple[str, Mapping[str, object]]] = []
