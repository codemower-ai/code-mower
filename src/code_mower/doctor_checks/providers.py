...
from .common import (
    ...
    _as_mapping,
    _as_sequence,
    _local_cli_remediation,
    _token_remediation,
    code_mower_config,
    code_mower_secrets,
    local_llm_profiles,
)
from .privacy import _auth_probe_output_detail
...
def _evaluate_json_probe(
    ...
    *,
    ...
    if dirty_errors:
        return STATUS_WARN, "probe reported provider/API error fields", detail
    if not response_matches:
        return STATUS_WARN, "probe response did not match expected sentinel", detail
