    ...
    *,
    ...
    if transport:
        checks.append(DoctorCheck(
            ...
            remediation="Use only declared capability modes; session messaging and cancellation are unavailable; authorized context is delivered only through the declared mode. Selection does not grant merge authority.",
        ))
