...
if __package__ in {None, "", "tools"}:
    try:
        from tools.yaml_subset import ConfigError, _YamlSubsetParser
    except ImportError:  # pragma: no cover - direct helper execution
        from yaml_subset import ConfigError, _YamlSubsetParser  # type: ignore
else:
    from .yaml_subset import ConfigError, _YamlSubsetParser
