            ...
            with ContextStore(self.root).locked("runtime"):
                with tempfile.TemporaryDirectory(prefix="decision-", dir=self.root) as temporary:
                    ...
                    instructions = (
                        ...
                        "excludes every contributor. In phase admit return accept only if this bounded work "
                        ...
                        "passed review and authoritative passed gate, or owner_action for recovery/fixes. "
