...
`0.5.0b23` is a beta release. Until Code Mower publishes a stable `1.0`
...
the latest 10/10 public-package readiness proof for `code-mower==0.5.0b23`.
...
The current public beta is `v0.5.0-beta.23` from
[codemower-ai/code-mower](https://github.com/codemower-ai/code-mower), published
as `code-mower==0.5.0b23` on [PyPI](https://pypi.org/project/code-mower/).
