...
fixtures, and the universal orchestrator prompt pack. Package-only users can
start from the public package rather than a source checkout.
...
the package-index procedure for `v1.0.0` / `code-mower==1.0.0`. The
