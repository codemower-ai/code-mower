...
[Try Code Mower In 10 Minutes](https://github.com/codemower-ai/code-mower/blob/v1.0.5/docs/try-in-10-minutes.md)
...
the package-index procedure for `v1.0.5` / `code-mower==1.0.5`. The
